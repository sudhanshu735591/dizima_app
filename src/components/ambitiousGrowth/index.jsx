function AmbitiousGrowth() {
  return (
    <div className="bg-gradient-to-r from-yellow-200 via-purple-300 to-purple-500 to-purple-500 text-black p-10">
      ...
      <div className="mt-10 lg:mt-20 flex flex-wrap gap-10 lg:gap-40 w-[90vw] m-auto text-start p-5 lg:p-10 lg:flex-nowrap justify-center">
        <div>
          <div className="flex flex-col gap-5 lg:gap-10">
            <h1 className="text-5xl sm:text-6xl lg:text-8xl font-bold">63%</h1>
            <p className="text-sm sm:text-base lg:text-lg">
              Blogs are 63% more likely to influence purchase decisions than ads.
            </p>
          </div>
        </div>
        <div>
          <div className="flex flex-col gap-5 lg:gap-10">
            <h1 className="text-5xl sm:text-6xl lg:text-8xl font-bold">20x</h1>
            <p className="text-sm sm:text-base lg:text-lg">
              Blogs are 63% more likely to influence purchase decisions than ads.
            </p>
          </div>
        ...
        <div>
          <div className="flex flex-col gap-5 lg:gap-10">
            <h1 className="text-5xl sm:text-6xl lg:text-8xl font-bold">72%</h1>
            <p className="text-sm sm:text-base lg:text-lg">
              Blogs are 63% more likely to influence purchase decisions than ads.
            </p>
          </div>
      ...
      <div className="border border-black w-[90%] m-auto mt-10 lg:mt-20"></div>
    </div>
  );
}
